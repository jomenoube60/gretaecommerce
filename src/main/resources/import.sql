...
insert into produit (id , nom , quantite_disponible , prixHt) values (null , "Steak+Frites"  , 1 , 10.99),(null , "Pates Bolognaises"  , 1 , 9.99),(null , "Dame Blanche"  , 1, 5.66),(null , "Coca" , 1 , 2.55),(null , "Poisson pané" , 1 , 7.99);
