...
insert into produit (id , nom , quantite_disponible, actif) values (null , "Steak+Frites"  , 1, true),(null , "Pates Bolognaises"  , 1, true),(null , "Dame Blanche"  , 1, true),(null , "Coca" , 1, true),(null , "Poisson pané" , 1, true);
