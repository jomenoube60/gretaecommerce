...
insert into produit (id , nom , quantite_disponible, actif, prix_Ht) values (null , "Steak+Frites"  , 1, true, 10.99),(null , "Pates Bolognaises"  , 1, true, 9.99),(null , "Dame Blanche"  , 1, true, 9.99),(null , "Coca" , 1, true, 9.99),(null , "Poisson pané" , 1, true, 9.99);
